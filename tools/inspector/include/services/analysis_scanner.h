...
public:
    ...
    void Start(ScanType type, const ScanConfig& config,
...
private:
    void RunEntityLifeTime(const ScanConfig& config,
                           VTX::IVtxReaderFacade* reader,
                           const VTX::PropertyAddressCache& cache,
                           const VTX::FileFooter& footer);

    void RunUniqueProperties(const ScanConfig& config,
                             VTX::IVtxReaderFacade* reader,
                             const VTX::PropertyAddressCache& cache,
                             const VTX::FileFooter& footer);

    void RunTrackProperty(const ScanConfig& config,
                          VTX::IVtxReaderFacade* reader,
                          const VTX::PropertyAddressCache& cache,
                          const VTX::FileFooter& footer);
