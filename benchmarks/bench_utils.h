...
namespace VtxBench {
    ...
    inline void SetNsPerFrame(benchmark::State& state, int64_t total_frames) {
        state.counters["ns_per_frame"] = benchmark::Counter(
            ...
            benchmark::Counter::kIsIterationInvariantRate | benchmark::Counter::kInvert, benchmark::Counter::kIs1000);
    }
...
#define BENCH_HEAVY_FIXTURE_SUFFIX ->Repetitions(5)->ReportAggregatesOnly(true)
