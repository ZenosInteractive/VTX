...
namespace VTX {
    ...
    public:
        ...
        void AppendActorList(VTX::Bucket& targetBlock, const std::string& schemaType, const FBVectorType* src_vector,
        ...
        void AppendSingleEntity(VTX::Bucket& targetBlock, const std::string& schemaType, const FBType* src_item,
                                IdExtractorFunc idExtractor) {
            if (!src_item)
                return;
        ...
        void LoadField(PropertyContainer& dest, const std::string& /*struct_name*/, const std::string& field_name,
            ...
            case FieldType::String:
                StoreValue(dest.string_properties, addr.index, value);
                break;
            case FieldType::Int8:
            case FieldType::Int32:
            case FieldType::Enum:
                StoreValue(dest.int32_properties, addr.index, value);
                break;
            case FieldType::Int64:
                StoreValue(dest.int64_properties, addr.index, value);
                break;
            case FieldType::Float:
                StoreValue(dest.float_properties, addr.index, value);
                break;
            case FieldType::Double:
                StoreValue(dest.double_properties, addr.index, value);
                break;
            case FieldType::Bool:
                StoreValue(dest.bool_properties, addr.index, value);
                break;
            case FieldType::Vector:
                StoreValue(dest.vector_properties, addr.index, value);
                break;
            case FieldType::Quat:
                StoreValue(dest.quat_properties, addr.index, value);
                break;
            case FieldType::Transform:
                StoreValue(dest.transform_properties, addr.index, value);
                break;
            case FieldType::FloatRange:
                StoreValue(dest.range_properties, addr.index, value);
                break;
            case FieldType::Struct:
                StoreValue(dest.any_struct_properties, addr.index, value);
                break;
            default:
                break;
            }
    ...
    private:
        ...
        void ExtractActorWithIdFunc(const ActorPtrT src, VTX::Bucket& block, const std::string& schemaType,
                                    IdExtractorFunc idExtractor) {
