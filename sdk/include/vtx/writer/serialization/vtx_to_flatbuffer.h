...
namespace VTX {
    namespace Serialization {
        ...
        flatbuffers::Offset<fbsvtx::MapContainer>      ToFlat(flatbuffers::FlatBufferBuilder& builder, VTX::MapContainer& src);
        flatbuffers::Offset<fbsvtx::PropertyContainer> ToFlat(flatbuffers::FlatBufferBuilder& builder, VTX::PropertyContainer& src);
