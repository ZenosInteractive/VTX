...
namespace {
    ...
    std::string WriteTwoFrameReplay(VTX::VtxFormat format, const std::string& path, F0 build0, F1 build1) {
...
INSTANTIATE_TEST_SUITE_P(BothBackends, DifferParametrizedTest,
